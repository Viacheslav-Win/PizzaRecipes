...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<RecyclerViewItem> pizzaList = new ArrayList<>();
            pizzaList.add(new RecyclerViewItem(R.drawable.marghuerita_1,"Next level Margherita pizza",
            ...
            pizzaList.add(new RecyclerViewItem(R.drawable.margarita_2,"Pizza Margherita in 4 easy steps",
            ...
            pizzaList.add(new RecyclerViewItem(R.drawable.caramelised_3,"Caramelised onion & goat's cheese pizza",
            ...
            pizzaList.add(new RecyclerViewItem(R.drawable.christmas_tree_pizza_4,"Christmas tree pizza tart",
                    "Bring festive fun to dinnertime with our tree-shaped pizza made with shop-bought pastry. Choose your own toppings, such as pancetta, chopped chipolatas and pesto",
                    "STEP 1\n" +
            ...
            pizzaList.add(new RecyclerViewItem(R.drawable.lahmacun_5,"Homemade Turkish lahmacun",
                    "Sometimes called 'Turkish pizza', this crispy flatbread topped with spiced mincemeat is a popular street food across the Middle East",
                    "STEP 1\n" +
            ...
            pizzaList.add(new RecyclerViewItem(R.drawable.pepperoni_6, "Pepperoni pizza rolls",
            ...
            pizzaList.add(new RecyclerViewItem(R.drawable.superhealthy_7,"Superhealthy pizza",
            ...
            pizzaList.add(new RecyclerViewItem(R.drawable.frying_pan_8,"Frying pan pizza",
            ...
            pizzaList.add(new RecyclerViewItem(R.drawable.eggrocketpizzas_9,"Egg & rocket pizzas",
            ...
            pizzaList.add(new RecyclerViewItem(R.drawable.sourdough_pizza_10,"Sourdough pizza",
                    ...
                    "will make a smooth sauce). Chill until needed.\n" +
                            "\n" +
                            "STEP 3\n" +
            ...
            pizzaList.add(new RecyclerViewItem(R.drawable.chicken_tikka_11,"Chicken tikka masala pizzas",
            ...
            adapter = new RecyclerViewAdapter(pizzaList, this);
